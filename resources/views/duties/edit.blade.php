...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-2xl mx-auto">
            <h1 class="text-4xl font-bold text-gray-800 mb-8">Dienst bearbeiten</h1>
            ...
            <div class="bg-white shadow-xl rounded-xl p-8">
                <form action="{{ route('duties.update', $duty) }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="date" name="date" value="{{ old('date', $duty->date) }}"
                    ...
                    <div class="mb-8">
                        ...
                        <input type="text" name="person_name" value="{{ old('person_name', $duty->person_name) }}"
