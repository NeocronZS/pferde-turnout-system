...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-2xl mx-auto">
            <h1 class="text-4xl font-bold text-gray-800 mb-8">Koppel bearbeiten</h1>

            <div class="bg-white shadow-xl rounded-xl p-8">
                <form action="{{ route('pastures.update', $pasture) }}" method="POST">
                    @csrf
                    @method('PUT')

                    <div class="mb-6">
                        <label class="block text-gray-700 font-bold mb-2 text-lg">Name der Koppel</label>
                        <input type="text" name="name" value="{{ old('name', $pasture->name) }}"
                    ...
                    <div class="mb-8">
                        ...
                        <input type="number" name="capacity" value="{{ old('capacity', $pasture->capacity) }}" min="1"
