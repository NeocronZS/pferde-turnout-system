...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-2xl mx-auto">
            <h1 class="text-4xl font-bold text-gray-800 mb-8">Neues Pferd anlegen</h1>
                ...
                <form action="{{ route('horses.store') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}"
                            ...
                            placeholder="z.B. Bella" required>
                        @error('name')
                    ...
                    <div class="mb-6">
                        ...
                        <select name="gender"
                            ...
                            <option value="Stute" {{ old('gender') == 'Stute' ? 'selected' : '' }}>Stute</option>
                            <option value="Wallach" {{ old('gender') == 'Wallach' ? 'selected' : '' }}>Wallach</option>
                        </select>
                    </div>

                    <div class="mb-6">
                        <label class="flex items-center cursor-pointer">
                            <input type="checkbox" name="box_rest" value="1" {{ old('box_rest') ? 'checked' : '' }}
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="box_number" value="{{ old('box_number') }}"
                            class="w-full border-2 border-gray-300 rounded-lg px-4 py-3 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition"
                            placeholder="z.B. B12">
                    </div>
                    ...
                    <div class="mb-8">
                        ...
                        <select name="owner_id"
                            class="w-full border-2 border-gray-300 rounded-lg px-4 py-3 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition @error('owner_id') border-red-500 @enderror"
                            required>
                    ...
                    <div class="flex gap-4">
                        <button type="submit"
                            class="flex-1 bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-6 rounded-lg shadow-lg transform hover:scale-105 transition">
                            Speichern
                        </button>
